...
const Pagination = ({ pageNumbers, currentPage }:PaginationType) => {
    ...
    return (
            <ul className={'flex flex-row gap-4 justify-center items-center mt-8'}>
                <li>
                    <Link href={ currentPage !== 1 ? `/blog/page/${currentPage-1}` : `/blog/page/${currentPage}`}><i className="bi bi-caret-left-fill text-lime-500 text-2xl hover:text-lime-600 cursor-pointer"></i></Link>
                </li>
                ...
                <li>
                    <Link href={pageNumbers.length !== currentPage ?`/blog/page/${currentPage+1}` : `/blog/page/${currentPage}`}><i className="bi bi-caret-right-fill text-lime-500 text-2xl hover:text-lime-600 cursor-pointer"></i></Link>
                </li>
            </ul>
    );
    };
