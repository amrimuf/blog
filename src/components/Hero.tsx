...
export default function Hero({profile}:{profile:About}){
    return (
        <section 
        className={`flex items-center justify-center layout bg-white/50 p-6 shadow-xl sm:shadow-2xl dark:bg-black/30 dark:shadow-lime-700 ${styles.handDrawnBorderHero}`} 
        data-fade='0'
        >
